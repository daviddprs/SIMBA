...
<div class="max-w-3xl">
    ...
    <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
        <h3 class="text-base font-semibold text-gray-800 mb-6 pb-4 border-b border-gray-100">Edit Video</h3>
        ...
        <form method="POST" action="{{ route('video.update', $video->id) }}" class="space-y-6">
            @csrf
            @method('PUT')

            <div>
                <label for="judul_video" class="form-label">Judul Video <span class="text-red-500">*</span></label>
                <input type="text" id="judul_video" name="judul_video" value="{{ old('judul_video', $video->judul_video) }}"
            ...
            <div>
                ...
                <input type="url" id="url_video" name="url_video" value="{{ old('url_video', $video->url_video) }}"
